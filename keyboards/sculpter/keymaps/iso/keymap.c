...
// ISO variant of the default keymap. Uses LAYOUT_iso, which adds the two
// ISO-only keys found on the Microsoft Sculpt ISO membrane:
//   - matrix [3, 11] -> KC_NUHS (the "#~" key, left of Enter)
//   - matrix [5,  4] -> KC_NUBS (the "\|" key, right of Left Shift)
